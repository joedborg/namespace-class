...
import (
	...
	"github.com/joedborg/namespace-class/internal/controller"
...
func init() {
	...
	utilruntime.Must(namespaceclassv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "befa37a1.josephb.org",
